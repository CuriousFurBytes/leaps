# Module 02: REST Resource Design

> REST constraints, resource modeling, representations, pagination, filtering, and errors.
...
REST Resource Design teaches the mental model behind rest constraints, resource modeling, representations, pagination, filtering, and errors. APIs are not just routes or schemas; they are long-lived contracts between people, programs, teams, and operational systems. A good API lets clients ask for useful work while protecting invariants, performance, and security.
