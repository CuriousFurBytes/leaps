# Module 02: SQL Foundations

> Read and write rows using SELECT, INSERT, UPDATE, DELETE, filtering, ordering, and transactions.
...
Read and write rows using SELECT, INSERT, UPDATE, DELETE, filtering, ordering, and transactions. This module is intentionally practical: every idea is tied to SQL you can run in `psql` or in any PostgreSQL client.
...
SQL grew from relational database research in the 1970s and became the common language for relational systems. PostgreSQL implements SQL while adding pragmatic extensions.
...
INSERT INTO notes (body) VALUES ('first note') RETURNING id;
```
...
UPDATE notes SET body = 'revised note' WHERE id = 1;
```
