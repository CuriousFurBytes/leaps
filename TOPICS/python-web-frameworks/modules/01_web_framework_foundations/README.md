# Module 01: Web Framework Foundations

> Learn HTTP, WSGI, ASGI, routing, request/response lifecycles, and when Django, FastAPI, or Flask fits.
...
Learn HTTP, WSGI, ASGI, routing, request/response lifecycles, and when Django, FastAPI, or Flask fits. This module is part of a full path from first web request to production-ready framework decisions.
...
- No prior module; this is the entry point.
