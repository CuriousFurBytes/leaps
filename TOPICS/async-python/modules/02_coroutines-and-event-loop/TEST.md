# Test: Module 02 — Coroutines and the Event Loop

**Instructions:** Answer all questions. Write your answers directly below each question.

**Total Points:** 37 pts (Easy: 5×1 + Medium: 5×2 + Hard: 4×3 + Expert: 2×5)
**Bonus Available:** 5 pts

> **Stub module** — Test questions to be generated when full module content is written.
...
**Bonus 1.** _To be written._ (+5 pts)
