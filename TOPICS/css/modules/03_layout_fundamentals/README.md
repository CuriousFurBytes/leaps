# Module 03: Layout Fundamentals

> Learn normal flow, flexbox, grid, and responsive layout fundamentals through practical CSS examples and the mental models behind them.
