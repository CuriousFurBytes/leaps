# Module 01: Introduction and the Cascade

> Learn CSS syntax, browser defaults, inheritance, and the cascade through practical CSS examples and the mental models behind them.
