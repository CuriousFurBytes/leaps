...
> Train and evaluate baseline supervised models for regression and classification.
...
Supervised learning uses labeled examples: each input comes with a target answer. The historical roots include regression, pattern recognition, and statistical classification. Modern libraries make training easy, but professional practice depends on choosing a baseline, splitting data honestly, selecting metrics, and interpreting errors rather than trusting a single score.
...
- Module 02: Data and Features in this topic.
- Basic [[python]] syntax and willingness to inspect predictions by hand.
...
- **Model** — A measurable part of the workflow that shapes what the model can learn. Poor choices here can dominate algorithm choice.
