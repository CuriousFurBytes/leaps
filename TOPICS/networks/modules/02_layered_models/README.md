# Module 02: Layered Models and Encapsulation

> This module explains why networks are divided into layers and how encapsulation lets independent protocols cooperate.
...
This module focuses on layers and encapsulation. It uses small commands and plain-language diagrams so you can connect vocabulary to observable behavior. The goal is to make the invisible visible: names become addresses, data becomes packets, and failures become testable hypotheses.
...
- Explain the purpose of protocol boundaries in practical network communication.
...
- Prepare for Module 03: IP Addressing and Subnetting.
