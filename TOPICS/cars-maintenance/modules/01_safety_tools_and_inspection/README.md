# Module 01: Safety, Tools, and Vehicle Inspection

> Learn how to approach a vehicle safely, identify core tools, and perform a first inspection.
...
This module introduces the car as a system that must be approached with respect. You will learn workspace safety, tool selection, vehicle identification, basic inspection habits, and the difference between a safe owner check and a repair that needs professional support.
...
- No prior module; this is the starting point for absolute beginners.
