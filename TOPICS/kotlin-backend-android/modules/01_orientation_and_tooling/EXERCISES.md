# Exercises: Module 01 — Orientation and Tooling
...
Write a five-sentence explanation of why **Orientation and Tooling** matters for Kotlin backend and Android work.
...
```kotlin
fun main() {
    println("Orientation and Tooling")
}
```
