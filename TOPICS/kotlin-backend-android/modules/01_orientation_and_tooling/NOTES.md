# Notes: Module 01 — Orientation and Tooling

> These are personal study notes for Module 01. Append insights, examples, confusions, and review summaries without deleting previous notes.

## Concept Map

```mermaid
mindmap
  root((Orientation and Tooling))
    Kotlin
    Backend
    Android
    Build Tools
